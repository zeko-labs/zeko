...
module Archive = struct
  type t = { mutable actions_map : Account_update_actions.t list Account_map.t }

  let create () = { actions_map = Account_map.empty }

  let add_actions t (account_update : Account_update.t) (account : Account.t) =
  ...
  let add_account_update t (account_update : Account_update.t) =
    add_actions t account_update
